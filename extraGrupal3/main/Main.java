package extraGrupal3.main;

import extraGrupal3.entidad.Cliente;
import extraGrupal3.service.ClienteService;
...
public class Main {
    public static void main(String[] args) {
        ...
        if(!clienteService.obtenerClientePorId(idPrueba).isPresent())
